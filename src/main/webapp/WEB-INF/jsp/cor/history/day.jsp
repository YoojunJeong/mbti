...
<common:body>
<script>mixpanel.track("cor day");</script>
	<!-- begin #content -->
	<div id="content" class="content">
		<!-- begin breadcrumb -->
		<ol class="breadcrumb pull-right">
        	<li class="active"><a href="/cor/history/period?mainmenu=m4&submenu=s1">HOME</a></li>
	        <li class="active"><a href="/cor/history/day?mainmenu=m4&submenu=s3">일기준</a></li>
    	</ol>
						...
						<div class="panel-body">
							...
							<div class="col-md-4">&nbsp;</div>
								<div class="col-md-1 text-right">
									<input class="btn btn-primary" href="javascript:;"
...
var gridDataSource = {
    "cache": false,
    "type": 'post',
    "url": '//${cms_api_domain}/1.0/cor/history/day',
...
$('#excel').on('click', function(e) {
	...
	location.href='/cor/history/day_xlsx?search_text=' + search_text + "&search_year=" + search_year + "&cor_idx=" + ${corIdx} + "&sub_cor_idx=" + idx;;
})
