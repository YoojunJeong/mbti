...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
	...
	<common:body>
	<script>mixpanel.track("cor password");</script>
<!-- begin #content -->
<div id="content" class="content">
	<!-- begin breadcrumb -->
	<ol class="breadcrumb pull-right">
        <li class="active"><a href="/cor/history/period?mainmenu=m4&submenu=s1">HOME</a></li>
        <li class="active"><a href="/cor/account/password?mainmenu=m4&submenu=s6">비밀번호 변경</a></li>
    </ol>
...
function check(pw) {
	$.ajax({
	    url: '//${cms_api_domain}/1.0/cor/account/check_pw',
	    type: 'post',
	    dataType: 'json',
	    async: false,
	    ...
	    data:JSON.stringify({'cor_idx': '${corIdx}', pw:pw}),
...
function change(pw) {
	$.ajax({
	    url: '//${cms_api_domain}/1.0/cor/account/change_pw',
	    type: 'post',
	    dataType: 'json',
	    async: false,
	    contentType: 'application/json',
	    ...
	    data:JSON.stringify({'login_id': '${loginId}', 'cor_idx': '${corIdx}', pw:pw}),
	    success: function(data) {
