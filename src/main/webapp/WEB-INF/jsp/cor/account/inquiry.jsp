...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
	...
	<common:body>
	<script>mixpanel.track("cor inquery");</script>
<!-- begin #content -->
<div id="content" class="content">
	<!-- begin breadcrumb -->
	<ol class="breadcrumb pull-right">
        <li class="active"><a href="/cor/history/period?mainmenu=m4&submenu=s1">HOME</a></li>
        <li class="active"><a href="/cor/account/inquiry?mainmenu=m4&submenu=s5">기본정보</a></li>
    </ol>
	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<div class="col-md-2">회원구분 : <span id="type"></span></div>
				</div>
				<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="panel panel-inverse">
				...
				<form id="modify_f" style="display:none" action="#">
					<div class="panel-body">
...
function modifyData() {
	...
	var phone = $('#i_phone').val().replace("-", "");
	console.log(phone);
	$.ajax({
	    url: '//${cms_api_domain}/1.0/cor/account/modify',
	    type: 'post',
	    dataType: 'json',
	    ...
	    data:JSON.stringify({name : name, dept: dept, position: position, phone: phone, cor_idx: '${corIdx}', login_id: '${loginId}'}),
...
function loadData() {
	$.ajax({
	    url: '//${cms_api_domain}/1.0/cor/account/inquiry',
	    type: 'post',
	    dataType: 'json',
	    contentType: 'application/json',
	    beforeSend: function(jqXHR, setting) {
	    ...
	    data:JSON.stringify({'cor_idx': '${corIdx}'}),
	    success: function(data) {
	            console.log(data);
	        insertList(data.body.list[0]);
	    }
...
function insertList(data) {
	...
	var i_dept = $('#i_position').val(data.manager_position);
...
$(function() {
	...
	// validate.addPhoneNumber($('#i_phone'));
