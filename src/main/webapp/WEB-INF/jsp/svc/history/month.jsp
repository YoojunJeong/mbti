...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko">
	...
	<common:body>
	<script>mixpanel.track("svc month");</script>
<!-- begin #content -->
<div id="content" class="content">
	<!-- begin breadcrumb -->
	<ol class="breadcrumb pull-right">
        <li class="active"><a href="/svc/history/sub_period?mainmenu=m5&submenu=s1">HOME</a></li>
        <li class="active"><a href="/svc/history/sub_month?mainmenu=m5&submenu=s2">월기준</a></li>
    </ol> 
...
var gridDataSource = {
    "cache": false,
    "type": 'post',
    "url": '//${cms_api_domain}/1.0/svc/history/month',
...
$('#excel').on('click', function(e) {
	e.preventDefault();
	// location.href = '/cor/history/month_xlsx?search_text=' + search_text + "&search_year=" + search_year + "&cor_idx=" + ${corIdx};
	location.href = '/svc/history/month_xlsx?search_text=' + search_text + "&search_year=" + search_year + "&svc_idx=" + ${corIdx} + "&cor_idx=" + idx;
})
